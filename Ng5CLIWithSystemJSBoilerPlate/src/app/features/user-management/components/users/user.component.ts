...
import { ManageUser } from '../manage-user/manageuser.component';
...
export class UserComponent implements OnInit {
    ...
    constructor(private _userService: UserService, private userfilter: UserFilterPipe, private dialog: MatDialog) {
